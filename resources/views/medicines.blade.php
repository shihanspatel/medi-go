...
<style>
    ...
    .styled-range::-webkit-slider-thumb {
        ...
        box-shadow: 0 0 0 1px #cbd5e1, 0 4px 8px rgba(0, 0, 0, 0.15);
                    ...
                    <div class="product-card">
                        <a href="{{ url('/view_product_') }}" class="text-decoration-none">
                            ...
                            <div class="card-body pb-0">
                                <div class="med-name text-dark" title="Paracetamol 500mg">Paracetamol 500mg</div>
                                <span class="med-dose">Strip of 10 Tablets</span>
                                <div class="d-flex align-items-center mb-3">
                                    <span class="price-tag text-dark">$2.50</span>
                                    <span class="old-price ms-2">$3.00</span>
                                </div>
                            </div>
                        </a>
                        <div class="px-3 pb-3">
