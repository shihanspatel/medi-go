    ...
    <div class="container">
        <div class="row align-items-center">
            ...
            <div class="col-lg-6 text-center" data-aos="fade-left">
                 <img src="images/pharmacy.webp" class="hero-img img-fluid" alt="Pharmacy">
            </div>
        </div>
    </div>
</section>
    ...
    <div class="container">
        ...
        <div class="row g-4">
            <div class="col-md-3 col-6" data-aos="fade-up">
                <div class="product-card">
                    <div class="prod-img-box">
                        ...
                        <img src="images/paracetamol-500mg-tablet.jpg" class="prod-img" alt="Med">
                    </div>
                    <div class="p-3">
            ...
            <div class="col-md-3 col-6" data-aos="fade-up" data-aos-delay="100">
                <div class="product-card">
                    <div class="prod-img-box">
                        <img src="images/benadry.webp   " class="prod-img" alt="Syrup">
                    </div>
                    <div class="p-3">
            ...
            <div class="col-md-3 col-6" data-aos="fade-up" data-aos-delay="200">
                <div class="product-card">
                    <div class="prod-img-box">
                        <img src="images/vitamin c.webp" class="prod-img" alt="Vitamins">
                    </div>
                    <div class="p-3">
            ...
            <div class="col-md-3 col-6" data-aos="fade-up" data-aos-delay="300">
                <div class="product-card">
                    <div class="prod-img-box">
                         <img src="images/digital thermometar.webp" class="prod-img" alt="Device">
                    </div>
                    <div class="p-3">
