...
<style>
    /* Hero */
    .hero-section { padding: 100px 0; background: radial-gradient(circle at top right, #d1fae5 0%, #ffffff 50%); overflow: hidden; }
    .hero-btn { background: var(--primary); color: white; padding: 15px 35px; border-radius: 50px; font-weight: 700; border: none; transition: 0.3s; }
    .hero-btn:hover { background: var(--primary-dark); transform: translateY(-3px); box-shadow: 0 10px 20px rgba(5, 150, 105, 0.3); }
    .hero-img { animation: float 6s ease-in-out infinite; max-height: 450px; }
    @keyframes float { 0%, 100% { transform: translateY(0px); } 50% { transform: translateY(-20px); } }

    /* Category Cards */
    .category-card { background: white; border: 1px solid #e2e8f0; padding: 25px; border-radius: 20px; text-align: center; transition: 0.3s; cursor: pointer; }
    .category-card:hover { border-color: var(--primary); transform: translateY(-5px); box-shadow: 0 10px 30px rgba(0,0,0,0.05); }
    .cat-icon-box { width: 70px; height: 70px; background: #ecfdf5; border-radius: 50%; display: flex; align-items: center; justify-content: center; margin: 0 auto 15px; color: var(--primary); font-size: 1.8rem; transition: 0.3s; }
    .category-card:hover .cat-icon-box { background: var(--primary); color: white; }

    /* Product Cards */
    .product-card { background: white; border: 1px solid #e2e8f0; border-radius: 20px; overflow: hidden; transition: 0.4s; position: relative; }
    .product-card:hover { transform: translateY(-10px); box-shadow: 0 15px 30px rgba(0,0,0,0.08); border-color: var(--primary); }
    .prod-img-box { height: 200px; background: #f8fafc; display: flex; align-items: center; justify-content: center; overflow: hidden; }
    .prod-img { height: 140px; transition: 0.5s; }
    .product-card:hover .prod-img { transform: scale(1.1); }
    .add-btn { width: 100%; border: 1px solid var(--primary); color: var(--primary); background: transparent; padding: 10px; border-radius: 10px; font-weight: 700; transition: 0.3s; }
            ...
            <div class="row align-items-center">
                <div class="col-lg-6 mb-5 mb-lg-0" data-aos="fade-right">
                    ...
                    <div class="d-flex gap-3">
                        ...
                        <button class="btn btn-outline-dark rounded-pill px-4 fw-bold"><i class="fas fa-file-upload me-2"></i>Upload Rx</button>
                    </div>
                </div>
    ...
    <section class="py-5">
        <div class="container">
            <div class="d-flex justify-content-between align-items-center mb-4">
                ...
                <a href="#" class="text-decoration-none fw-bold text-success">View All <i class="fas fa-arrow-right"></i></a>
            </div>
            <div class="row g-4">
